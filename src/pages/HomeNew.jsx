    ...
    return (
        <>
            ...
            <div className="fixed inset-0 pointer-events-none z-0">
                <div className="absolute top-0 right-1/4 w-[800px] h-[800px] bg-[#240993] rounded-full blur-[150px] opacity-30 mix-blend-screen animate-pulse duration-[8s]" />
                <div className="absolute bottom-0 left-1/4 w-[600px] h-[600px] bg-[#7112AF] rounded-full blur-[120px] opacity-20 mix-blend-screen animate-pulse duration-[6s]" />
                <div className="absolute top-1/2 left-1/2 w-[400px] h-[400px] bg-[#ff006e] rounded-full blur-[100px] opacity-10 mix-blend-screen animate-pulse duration-[4s]" />
            </div>

            {/* Hero */}
            <section className="relative min-h-[100vh] flex flex-col items-center justify-center pt-12 overflow-hidden">
                <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
                    <div className="text-center lg:text-right order-2 lg:order-1">
                        <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-[#7112AF]/10 text-[#d4b3ff] border border-[#7112AF]/30 text-sm font-bold mb-8 backdrop-blur-md shadow-[0_0_25px_rgba(113,18,175,0.3)]">
                            <span className="relative flex h-3 w-3">
                                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#7112AF] opacity-75"></span>
                                <span className="relative inline-flex rounded-full h-3 w-3 bg-[#7112AF]"></span>
                            </span>
                            <TypewriterText text="البيئة التعليمية الآمنة المتقدمة..." />
                        </div>
                        ...
                        >
                            <h1 className="text-4xl md:text-7xl font-black tracking-tight text-white mb-8 leading-[1.2]">
                                التدريب السيبراني <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-l from-[#7112AF] via-[#b66dff] via-[#ff006e] to-[#7112AF] bg-[300%_auto] animate-gradient">
                                    الإدراكي المتقدم
                                </span>
                            </h1>
                            
                            <p className="text-xl md:text-2xl text-[#bbb6d1] mb-12 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-light">
                                ليس مجرد كتابة أوامر. نحن نعلمك كيف تفكر الأنظمة، كيف تفشل، وكيف تحميها. 
                                <span className="text-[#ff006e] font-bold"> كل خطأ هو جريمة</span>، 
                                كل قرار له عواقب.
                            </p>
                        ...
                        >
                            <div className="relative">
                                ...
                                <motion.div
                                    ...
                                    className="absolute -top-8 -left-8 w-16 h-16 bg-gradient-to-br from-[#7112AF] to-[#ff006e] rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(113,18,175,0.5)]"
                                >
                                ...
                                <motion.div
                                    ...
                                    className="absolute -bottom-6 -right-6 w-12 h-12 bg-gradient-to-br from-[#ff006e] to-[#7112AF] rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(255,0,110,0.5)]"
                                >
                                ...
                                <motion.div
                                    ...
                                    className="absolute top-1/2 -left-12 w-8 h-8 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center"
                                >
                ...
                >
                    <div className="w-6 h-10 border-2 border-[#7112AF]/30 rounded-full flex justify-center">
                        <div className="w-1 h-3 bg-[#7112AF] rounded-full mt-2" />
                    </div>
                </motion.div>
            </section>
